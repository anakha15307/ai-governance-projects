...
- [ ] **Go**
- [ ] **Conditional-go** (conditions in §3)
- [ ] **No-go**
...
| # | Condition | Owner | Due date | Lapse rule |
|---|---|---|---|---|
| 1 | [Specific, measurable] | [Name] | [YYYY-MM-DD] | If unmet by due date, decision lapses to no-go |

## Dissent

- [None recorded / Name: position and rationale]

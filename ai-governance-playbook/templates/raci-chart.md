...
|---|---|---|---|---|---|---|---|
| Intake triage & tiering | I | A | R | R | C | I | I |
...
| Incident response | A† | R | R | C | R | C | R |
| Vendor assessment | I | A | C | R | R | C | C |
| Regulatory change review | I | A/R | C | R | I | I | C |
| Program metrics & board report | I | A/R | R | C | I | I | I |

\* A per-control: each control has exactly one named accountable owner.
† A for SEV-1 incidents and Tier-4 deployments (executive sponsor).
‡ R for operating their assigned controls and reporting status.
